...
const Service11 = () => {
 ...
 <section className="text-gray-600 body-font">
  <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
    <img className="lg:w-3/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src={car1}/>
    <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Car Washing </h1>
